...
<nav class="topbar-custom d-flex justify-content-between" id="topbar-custom">    
                    ...
                    <ul class="topbar-item list-unstyled d-inline-flex align-items-center mb-0">                        
                        ...
                        <li class="mx-3 welcome-text">
                            <h3 class="mb-0 fw-bold text-truncate">Good Morning, Alhassan!</h3>
                    ...
                    <ul class="topbar-item list-unstyled d-inline-flex align-items-center mb-0">
                        ...
                        <li class="dropdown">
                            ...
                            <img src="{{ asset('images/flags/us_flag.jpg') }}" alt="" class="thumb-sm rounded-circle">
                            </a>
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="#"><img src="{{ asset('images/flags/us_flag.jpg') }}" alt="" height="15" class="me-2">English</a>
                                <a class="dropdown-item" href="#"><img src="{{ asset('images/flags/spain_flag.jpg') }}" alt="" height="15" class="me-2">Spanish</a>
                                <a class="dropdown-item" href="#"><img src="{{ asset('images/flags/germany_flag.jpg') }}" alt="" height="15" class="me-2">German</a>
                                <a class="dropdown-item" href="#"><img src="{{ asset('images/flags/french_flag.jpg') }}" alt="" height="15" class="me-2">French</a>
                            </div>
                        ...
                        <li class="dropdown topbar-item">
                            <a class="nav-link dropdown-toggle arrow-none nav-icon" data-bs-toggle="dropdown" href="#" role="button"
                                aria-haspopup="false" aria-expanded="false">
                                <img src="{{ asset('images/users/avatar-1.jpg') }}" alt="" class="thumb-lg rounded-circle">
                            </a>
                            <div class="dropdown-menu dropdown-menu-end py-0">
                                <div class="d-flex align-items-center dropdown-item py-2 bg-secondary-subtle">
                                    ...
                                    <div class="flex-grow-1 ms-2 text-truncate align-self-center">
                                        <h6 class="my-0 fw-medium text-dark fs-13">Mohammed Alhassan</h6>
